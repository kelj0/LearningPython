...
def draw_board(the_board):
    ...
    n = len(the_board)    # This is a NxN chess board
    surface_sz = 480      # Proposed physical surface size
    sq_sz = surface_sz//n # sq_sz is len of a square
    surface_sz = n*sq_sz  # Adjust to exactly fin n squares

    surface = pygame.display.set_mode((surface_sz,surface_sz))
    ball = pygame.image.load("/home/keljo/Pictures/chess.png")
